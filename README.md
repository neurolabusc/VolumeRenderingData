...
This repository provides sample datasets for volume rendering. The voxelwise data is saved in the [NIfTI](https://nifti.nimh.nih.gov/nifti-1/data) format. All of these samples are open source. See specific folders for sources and individual licenses.
